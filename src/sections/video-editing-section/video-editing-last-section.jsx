...
const VideoEditingLastSection = ({ hasShape }) => {
        ...
        <Grid container justifyContent="center">
          <Grid item xs={12} md={8} textAlign="center">
            <Typography
              ...
              fontWeight={700}
            >
              {t('videoEditingLastSectionHeading')}
            </Typography>
            <Typography
              variant="body1"
              lineHeight={1.5}
              ...
              fontWeight={500}
            >
              {t('videoEditingLastSectionDescription')}
            </Typography>
...
VideoEditingLastSection.propTypes = {
  hasShape: PropTypes.bool,
};
 
export default VideoEditingLastSection;
