...
const BlogsLastSection = ({ hasShape }) => {
  const { t } = useTranslation();
  return (
    <Box pt="50px" pb="100px" position="relative" zIndex={-1}>
      {hasShape && (
        <img
          width="100%"
          height="200px"
...
BlogsLastSection.propTypes = {
  hasShape: PropTypes.bool,
};
 
export default BlogsLastSection;
