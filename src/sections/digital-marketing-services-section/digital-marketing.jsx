...
const DigitalMarketingServicesSection = ({ heading }) => {
          ...
          >
            ...
            <Grid item xs={12} md={6} order={{ md: 1, xs: 2 }}>
              <img
                ...
                src="/assets/additional-services/DigiMark/seo.png"
                alt="logo-name"
              />
            </Grid>
            ...
            <Grid item xs={12} md={6} order={{ md: 4, xs: 4 }}>
              <img
                data-aos="fade-left"
                data-aos-duration="1000"
                src="/assets/additional-services/DigiMark/SMM.png"
                alt="logo-name"
              />
            </Grid>
            <Grid item xs={12} md={6} order={{ md: 5, xs: 6 }}>
              <img
                data-aos="fade-right"
                data-aos-duration="1000"
                src="/assets/additional-services/DigiMark/contMark.png"
                alt="logo-name"
              />
            </Grid>
            ...
            <Grid item xs={12} md={6} order={{ md: 8, xs: 8 }}>
              <img
                data-aos="fade-left"
                data-aos-duration="1000"
                src="/assets/additional-services/DigiMark/PPC.png"
                alt="logo-name"
              />
            </Grid>
            <Grid item xs={12} md={6} order={{ md: 9, xs: 10 }}>
              <img
                data-aos="fade-right"
                data-aos-duration="1000"
                src="/assets/additional-services/DigiMark/EmailMark.png"
                alt="logo-name"
              />
            </Grid>
            ...
            <Grid item xs={12} md={6} order={{ md: 12, xs: 12 }}>
              <img
                data-aos="fade-left"
                data-aos-duration="1000"
                src="/assets/additional-services/DigiMark/AnaRep.png"
                alt="logo-name"
              />
            </Grid>
            <Grid item xs={12} md={6} order={{ md: 13, xs: 14 }}>
              <img
                data-aos="fade-right"
                data-aos-duration="1000"
                src="/assets/additional-services/DigiMark/web.png"
                alt="logo-name"
              />
            </Grid>
...
DigitalMarketingServicesSection.propTypes = {
