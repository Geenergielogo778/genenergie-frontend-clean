...
const CopyWritingSection = ({ heading }) => {
          ...
          >
            ...
            <Grid item xs={12} md={6} order={{ md: 1, xs: 2 }}>
              <img
                ...
                src="/assets/additional-services/copyWriting/engPersuasive.jpeg"
                alt="logo-name"
              />
            </Grid>
            ...
            <Grid item xs={12} md={6} order={{ md: 4, xs: 4 }}>
              <img
                data-aos="fade-left"
                data-aos-duration="1000"
                src="/assets/additional-services/copyWriting/seoOp.png"
                alt="logo-name"
              />
            </Grid>
            <Grid item xs={12} md={6} order={{ md: 5, xs: 6 }}>
              <img
                data-aos="fade-right"
                data-aos-duration="1000"
                src="/assets/additional-services/copyWriting/brand.png"
                alt="logo-name"
              />
            </Grid>
            ...
            <Grid item xs={12} md={6} order={{ md: 8, xs: 8 }}>
              <img
                data-aos="fade-left"
                data-aos-duration="1000"
                src="/assets/additional-services/copyWriting/audience.png"
                alt="logo-name"
              />
            </Grid>
            <Grid item xs={12} md={6} order={{ md: 9, xs: 10 }}>
              <img
                data-aos="fade-right"
                data-aos-duration="1000"
                src="/assets/additional-services/copyWriting/messaging2.png"
                alt="logo-name"
              />
            </Grid>
            ...
            <Grid item xs={12} md={6} order={{ md: 12, xs: 12 }}>
              <img
                data-aos="fade-left"
                data-aos-duration="1000"
                src="/assets/additional-services/copyWriting/conversion.png"
                alt="logo-name"
              />
            </Grid>
            <Grid item xs={12} md={6} order={{ md: 13, xs: 14 }}>
              <img
                data-aos="fade-right"
                data-aos-duration="1000"
                src="/assets/additional-services/copyWriting/ongoing.png"
                alt="logo-name"
              />
            </Grid>
