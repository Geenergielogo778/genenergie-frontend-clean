...
const WebDevelopmentSection = ({ heading }) => {
  const { t } = useTranslation();
  const webDevOne = t('webDevOne'); 
  const webDevOneContent = t('webDevOneContent');
          ...
          >
            <Grid item xs={12} md={6} order={{ md: 1, xs: 2 }}>
              <img
                ...
                src="/assets/additional-services/webDev/webD1.png"
                alt="logo-name"
              />
            </Grid>
            ...
            <Grid item xs={12} md={6} order={{ md: 4, xs: 4 }}>
              <img
                data-aos="fade-left"
                data-aos-duration="1000"
                src="/assets/additional-services/webDev/webD2.png"
                alt="logo-name"
              />
            </Grid>
            <Grid item xs={12} md={6} order={{ md: 5, xs: 6 }}>
              <img
                data-aos="fade-right"
                data-aos-duration="1000"
                src="/assets/additional-services/webDev/webD3.png"
                alt="logo-name"
              />
            </Grid>
            ...
            <Grid item xs={12} md={6} order={{ md: 8, xs: 8 }}>
              <img
                data-aos="fade-left"
                data-aos-duration="1000"
                src="/assets/additional-services/webDev/webD4.png"
                alt="logo-name"
              />
            </Grid>
            <Grid item xs={12} md={6} order={{ md: 9, xs: 10 }}>
              <img
                data-aos="fade-right"
                data-aos-duration="1000"
                src="/assets/additional-services/webDev/webD5.png"
                alt="logo-name"
              />
            </Grid>
            ...
            <Grid item xs={12} md={6} order={{ md: 12, xs: 12 }}>
              <img
                data-aos="fade-left"
                data-aos-duration="1000"
                src="/assets/additional-services/webDev/webD6.png"
                alt="logo-name"
              />
            </Grid>
            <Grid item xs={12} md={6} order={{ md: 13, xs: 14 }}>
              <img
                data-aos="fade-right"
                data-aos-duration="1000"
                src="/assets/additional-services/webDev/webD7.png"
                alt="logo-name"
              />
            </Grid>
