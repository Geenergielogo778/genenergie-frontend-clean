...
const WebDevelopmentLastSection = ({ hasShape }) => {
        ...
        <Grid container justifyContent="center">
          <Grid item xs={12} md={8} textAlign="center">
            ...
            <Typography
              ...
              fontWeight={500}
            >
              {t('webDevLastSectionDescription')}
            </Typography>
...
WebDevelopmentLastSection.propTypes = {
  hasShape: PropTypes.bool,
};
 
export default WebDevelopmentLastSection;
